export abstract class HeadlineTagSelectors {
    static readonly NOTICE_BOARD: string = '.artclTable .headline';
...
export abstract class PageTagSelectors {
    static readonly PAGE_BOARD: string = '._paging ._inner';
    static readonly LAST_PAGE: string = 'a._last';
}