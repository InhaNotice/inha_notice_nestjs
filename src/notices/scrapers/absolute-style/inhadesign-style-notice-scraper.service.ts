...
import { GeneralTagSelectors } from "src/notices/selectors/inhadesign-style-tag-selectors";
...
export class InhadesignStyleNoticeScraperService extends AbsoluteStyleScraperService {
    ...
    fetchGeneralNotices($: cheerio.CheerioAPI, baseUrl: string): Notice[] {
        ...
        generals.each((_, element) => {
            ...
            const writer: string = IdentifierConstants.UNKNOWN_WRITER;
            const access: string = IdentifierConstants.UNKNOWN_ACCESS;
