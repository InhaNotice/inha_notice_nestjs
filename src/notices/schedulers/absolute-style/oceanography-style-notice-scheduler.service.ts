...
export class OceanographyStyleNoticeSchedulerService extends AbsoluteStyleNoticeSchedulerService {
    ...
    @Cron(OceanographyStyleNoticeSchedulerConstants.CRON_WEEKDAYS, { timeZone: 'Asia/Seoul' })
    async handleWeekDaysCron() {
        await this.executeCrawling(OceanographyStyleNoticeSchedulerConstants.TASK_WEEKDAYS);
    }

    @Cron(OceanographyStyleNoticeSchedulerConstants.CRON_DELETE_OLD, { timeZone: 'Asia/Seoul' })
    async handleDeleteCron() {
        await this.deleteOldNotices(OceanographyStyleNoticeSchedulerConstants.TASK_DELETE_OLD);
    }
