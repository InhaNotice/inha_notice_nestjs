...
import { InhadesignStyleNoticeScraperService } from "src/notices/scrapers/absolute-style/inhadesign-style.scraper";
import * as path from 'path';
import { Cron } from "@nestjs/schedule";
import { Notice } from 'src/notices/interfaces/notice.interface';
import { InhadesignStyleConstant } from "src/constants/notice/scheduler/inhadesign-style.constant";
