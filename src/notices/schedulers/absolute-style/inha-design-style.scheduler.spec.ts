...
import { InhaDesignStyleScheduler } from 'src/notices/schedulers/absolute-style/inha-design-style.scheduler';

class TestSchedulerService extends InhaDesignStyleScheduler {
    constructor() {
...
describe('InhaDesignStyleScheduler', () => {
    ...
    describe('handleWeekDays 메서드는', () => {
        ...
        beforeEach(async () => {
            ...
            executeCrawlingMock = jest.spyOn<any, any>(service, 'executeCrawling').mockImplementation();
        });
    ...
    describe('handleDelete 메서드는', () => {
        ...
        beforeEach(async () => {
            service = new TestSchedulerService();
            deleteOldNoticesMock = jest.spyOn<any, any>(service, 'deleteOldNotices').mockImplementation();
        });
