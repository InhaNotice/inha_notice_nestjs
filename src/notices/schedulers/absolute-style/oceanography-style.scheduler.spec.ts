...
import { OceanographyStyleScheduler } from './oceanography-style.scheduler';

class TestSchedulerService extends OceanographyStyleScheduler {
    constructor() {
...
describe('OceanographyStyleScheduler', () => {
